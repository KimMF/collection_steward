...
/**
 * Production cast assignment, asset checkout, and checkout correction.
 *
 * Public entry point: /checkout.php
 */
require dirname(__DIR__) . '/lib/application.php';

startCollectionStewardSession();

// Checkout is available only to signed-in users with the checkout capability.
...
// Only planned or active productions may receive new checkout activity.
...
// All mutations share production validation and CSRF protection before their
// action-specific transaction begins.
...
// Convert redirect flags into a single confirmation message.
...
// Load the selected production's cast, available assets, and current checkouts.
...
// Render the production checkout workspace.
?>
<!DOCTYPE html>
<html lang="en">
<head>
