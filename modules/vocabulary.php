...
/**
 * Review and resolution of controlled-vocabulary suggestions from intake.
 *
 * Public entry point: /vocabulary.php
 */
require dirname(__DIR__) . '/lib/application.php';

startCollectionStewardSession();

// Vocabulary review requires steward or administrator permission.
...
// This fixed map is the only source of table and column names used below. User
// input selects a map key; it is never inserted directly into SQL identifiers.
$vocabularies = [
    'asset_type' => [
        'label' => 'Item type',
        'table' => 'asset_types',
...
// Resolve one pending suggestion inside a transaction so the vocabulary,
// related asset, and review record remain consistent.
...
// Load approved match choices and the remaining review queue.
$optionsByVocabulary = [];
...
// Render the vocabulary review queue.
?>
<!DOCTYPE html>
<html lang="en">
<head>
